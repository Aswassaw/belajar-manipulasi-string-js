...
let asw = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo doloribus non rerum natus placeat iure laudantium alias. Vero suscipit, aspernatur esse maiores dicta, odio quae quos at molestias, consequatur soluta.";

let no = 0;
for(let i = 0; i < asw.length/8; i++){
    console.log(asw.slice(no, no+8));
    no += 8;
}